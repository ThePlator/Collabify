        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-4 md:mb-6">
            <button
              ...
              className="w-full md:w-auto px-4 md:px-6 py-3 bg-gradient-to-r from-[#3F1D9B] to-[#6747C7] text-white rounded-xl font-semibold hover:opacity-90 transition-all shadow-md shadow-purple-500/20 flex items-center justify-center md:justify-start gap-2">
              <FaBriefcase className="w-5 h-5" />
              {isPosting ? 'View Projects' : 'Post a Project'}
            </button>
          </div>

          {/* Conditional Render: Job Posting Form or Projects List */}
          {isPosting ? (
            <JobPosting />
          ) : (
            <div>
